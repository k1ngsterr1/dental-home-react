          ...
          <div className="information-container">
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                функциональность и эстетику вашей улыбки. Наша команда опытных
                ортопедов предлагает следующие виды протезирования:
                <br />
                <br />
                ...
                восстановления отсутствующих зубов. Они могут быть съемными или
                несъемными, в зависимости от вашего индивидуального случая.
                Съемные протезы легко снимаются и очищаются, что облегчает уход
                за ними. Несъемные протезы, такие как мостовидные конструкции,
                крепятся на соседние зубы или имплантаты, что обеспечивает более
                надежную фиксацию.
                <br />
                <br />
                ...
                когда часть зуба сохранена. Они представляют собой капу, которая
                надевается на зуб, полностью покрывая его. Коронки могут быть
                изготовлены из различных материалов, таких как металлокерамика,
                цельнокерамические материалы или металлы высокой прочности. Мы
                поможем вам выбрать наиболее подходящий материал с учетом ваших
                ...
                используем только качественные имплантаты, которые обеспечивают
                долговечность и эстетическую привлекательность. Заголовок 2:
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                специалисты проводят детальную консультацию и обследование перед
                началом лечения. Мы учитываем ваши пожелания и финансовые
                возможности, чтобы подобрать оптимальный тип протеза и материал.
                <br />
                <br />
                <strong>2.2 Использование современных технологий</strong>
                <br />
                <br />
                В клинике Dental Home мы постоянно следим за новыми технологиями
                и используем только современное оборудование. Это позволяет нам
                достичь высокой точности и качества восстановления зубов,
                сокращая время лечения и повышая комфортность для пациентов.
                <br />
                <br />
                ...
                которые гарантируют высокое качество и долговечность протезов.
                Это позволяет нам предложить нашим пациентам надежные и
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                <br />
                <br />
                Перед началом лечения мы проводим детальную консультацию, в ходе
                которой определяем ваши цели и ожидания от протезирования. На
                основе этой информации мы разрабатываем индивидуальный план
                лечения.
                <br />
                <br />
                ...
                <br />
                <br />
                В некоторых случаях может потребоваться подготовительная работа,
                такая как удаление зубов или лечение зубочелюстной системы. Наша
                команда специалистов проведет все необходимые процедуры перед
                протезированием.
                <br />
                <br />
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                предлагаем широкий спектр услуг, индивидуальный подход к каждому
                пациенту, использование современных технологий и качественных
                материалов. Обратившись к нам, вы получите красивую и здоровую
            ...
            <div className="plate">
              <section className="tab-one">
                <h5 className="plate-heading">Протезирование на имплантах</h5>
                <span className="text">
              ...
              <section className="tab-two">
                <span className="text">
                  Единица промежуточной части временного мостовидного протеза с
                  опорой на имплантах
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Протезирование зуба с использованием имплантата коронкой
                  металлокерамической класса "стандарт" (цементная фиксация) на
                  индивидуальном абатменте
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Протезирование зуба с использованием имплантата коронкой
                  металлокерамической класса "Премиум" (цементная фиксация) на
                  индивидуальном абатменте
                </span>
                <span className="price">31 000₽</span>
              </section>
              ...
              <section className="tab-three">
                <span className="text">
                  Протезирование зуба с использованием имплантата коронокой из
                  диоксида циркония класса "Стандарт"(трансокклюзионная
                  фиксация)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Протезирование зуба с использованием имплантата коронокой из
                  диоксида циркония класса "Премиум"(трансокклюзионная фиксация)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  ...
                  Протезирование зуба с использованием имплантата коронокой из
                  диоксида циркония класса "Премиум"(трансокклюзионная фиксация)
                  на индивидуальном абатмене
                </span>
                <span className="price">45 000₽</span>
              </section>
              <section className="tab-three">
                <span className="text">
                  Единица промежуточной части мостовидного протеза из диоксида
                  циркония класса "Стандарт" с опорой на имплантатах
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Единица промежуточной части мостовидного протеза из диоксида
                  циркония класса "Премиум" с опорой на имплантатах
                </span>
                <span className="price">26 0000₽</span>
              </section>
              <section className="tab-three">
                <span className="text">
                  Протезирование зуба с использованием имплантата коронкой E-max
                  на титановом основании класса "Премиум" (трансокклюзионная
                  фиксация)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  ...
                  имплантатах (балочная конструкция) мультиюниты оплачиваются
                  отдельно
                </span>
              ...
              <section className="tab-three">
                <span className="text">Стоимость мультиюнита (1 единица) </span>
            ...
            >
              ...
              <section className="tab-three">
                <span className="text">
                  ...
                  зуба с применением лекарственных средств (лечение заболеваний
                  пародонта аппаратом "Vector Para Pro" в области 1
                  зуба/импланта)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Ультразвуковая обработка пародонтального кармана в области
                  зуба с применением лекарственных средств (лечение заболеваний
                  пародонта аппаратом "Vector Para Pro" 2 челюсти)
                </span>
                <span className="price">10 000₽</span>
              </section>
              <section className="tab-three">
                <span className="text">
                  Лазерная физиотерапия челюстно-лицевой области (1 процедура)
                </span>
            ...
            <div className="services-information" id="information">
              ...
              <div className="information-one">
                ...
                <p className="p-info">
                  ...
                  высокой прочности. Мы поможем вам выбрать наиболее подходящий
                  материал с учетом ваших индивидуальных потребностей.
                  <br />
                  <br />
                  <strong> 1.3 Имлпанты</strong>
                  <br />
                  ...
                  Заголовок 2: Преимущества протезирования в клинике Dental Home
                </p>
              </div>
              <div className="information-two">
                ...
                <p className="p-info two">
                  ...
                  технологиями и используем только современное оборудование. Это
                  позволяет нам достичь высокой точности и качества
              ...
              <div className="information-two">
                ...
                <p className="p-info two">
                  ...
                  красивую и здоровую улыбку, которая прослужит вам долгие годы.
                </p>
              </div>

              <div className="price-tab" id="prices">
                <h4 className="price-heading">Протезирование на имплантах</h4>
