          ...
          <div className="information-container">
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                Стоматологическое лечение может вызывать страх и боязнь у детей.
                Но необходимо помнить, что здоровье зубов является важной частью
                общего здоровья ребенка. Для преодоления этой проблемы, наша
                клиника предлагает адаптационный прием. Этот прием позволяет
                ребенку познакомиться с клиникой и работой врача стоматолога в
                кабинете. В конце приема ребенок получает подарок, который
                поможет сохранить приятные воспоминания о первом посещении
                стоматолога. Такой прием помогает многим детям преодолеть страх
                и боязнь перед лечением зубов. Однако, в случае если страх
                сильнее, особенно у детей до 4 лет, мы рекомендуем лечение под
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                зубы, также как и постоянные, имеют корни и внутри них находится
                нерв. Поэтому кариес может вызывать болезненные ощущения у
                ребенка и требует лечения с применением анестезии. Наша команда
                специалистов обладает опытом и знаниями, чтобы провести лечение
                кариеса у детей максимально безболезненно и эффективно. Мы
                используем современные методы и технологии, чтобы обеспечить
                комфорт и безопасность вашего ребенка во время лечения.
                Заголовок 3: Важность лечения передних зубов у детей.
              </p>
            </section>
            <section className="information">
              <h3 className="information-heading">
              ...
              <p className="information-paragraph">
                Кариозные передние зубы не только являются источником инфекции в
                полости рта, но и могут оказывать негативное влияние на
                эстетический вид и социальное самочувствие ребенка. Ребенок с
                поврежденными или черными зубами может испытывать стеснение при
                улыбке и развить комплекс неполноценности. Поэтому лечение
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                Регулярные посещения стоматолога и профессиональная чистка зубов
                являются важной частью ухода за здоровьем детских зубов. Кариес
                может распространяться быстро и вызывать болезненные ощущения.
                Поэтому, чтобы избежать проблем, рекомендуется посещать
                стоматолога раз в 3 месяца для осмотра и профилактических
                процедур. Наша команда опытных специалистов готова предоставить
                вашему ребенку качественное и безопасное лечение, помогая ему
                сохранить здоровье и красивую улыбку.
              </p>
            </section>
          </div>
        </div>
