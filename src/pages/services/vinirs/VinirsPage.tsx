          ...
          <div className="information-container">
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                Под коронку всегда нужно препарировать зуб, чтобы создать место
                для ее установки
                <br />
                <br />
                <strong>
                ...
                ожидания от процедуры. На основе этой информации разрабатывается
                ...
                <br />
                <br />В лаборатории специалисты изготавливают виниры или коронки
                из выбранного материала с учетом индивидуальных потребностей
                пациента.
                <br />
                <br />
                ...
                <br />
                <br />
                После изготовления протеза он устанавливается на зуб с помощью
                специального цемента или клея. Врач проверяет соответствие
                протеза ожиданиям пациента и вносит необходимые корректировки.
              </p>
            </section>
            <div className="divider"></div>
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                <br />
                <br />
                - Функциональность. Протезы восстанавливают поврежденные зубы,
                обеспечивая нормальное жевание и речь.
                <br />
                <br />
                ...
                <br />
                <br />
                - Безопасность. Материалы, используемые для изготовления виниров
                и коронок, не вызывают аллергических реакций и не
                взаимодействуют с тканями ротовой полости.
                <br />
                <br />
                Если вы ищете качественные стоматологические услуги по установке
                виниров и коронок в Ивантеевке, обратитесь в нашу клинику Dental
                Home. Наша команда опытных специалистов гарантирует высокое
                качество работы, индивидуальный подход к каждому пациенту и
                использование современных технологий. Мы поможем вам достичь
                желаемого результата и получить красивую улыбку.
              </p>
            </section>
            ...
            >
              ...
              <section className="tab-three">
                <span className="text">
                  Снятие оттиска с одной челюсти для изготовления силиконового
                  ключа
                </span>
                <span className="price">1 500₽</span>
              </section>
              <section className="tab-three">
                <span className="text">
                  Снятие оттиска с одной челюсти с имплантов с использованием
            ...
            >
              ...
              <section className="tab-three">
                <span className="text">
                  ...
                  драгоценном сплаве (без учета стоимости драгоценного металла)
                </span>
                <span className="price">18 500₽</span>
              </section>
              <section className="tab-three">
            ...
            >
              <section className="tab-one">
                <h5 className="plate-heading">Съемные, Бюгельные протезы</h5>
                <span className="text">
              ...
              <section className="tab-two">
                <span className="text">
                  ...
                  временного замещения отсутствующих 1-3 зубов (иммедиат-протез)
                </span>
          ...
          <div className="services-content">
            ...
            <div className="services-information" id="information">
              ...
              <div
                ...
                style={{ marginTop: "clamp(16px,1.66656vw,64px)" }}
              >
                <h4 className="price-heading">Съемные, Бюгельные протезы</h4>
                <div className="prices">
                  <div className="price-row">
                    <span className="text">
                      Протезирование зубов полным съемным пластиночным протезом
