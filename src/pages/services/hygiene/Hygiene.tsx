        ...
        <div className="content">
          ...
          <div className="information-container">
            ...
            <div className="plate">
              ...
              <section className="tab-three">
                <span className="text">
                  Профессиональная гигиена полости рта и зубов(ультразвуковое
                  удаление зубных отложений, AirFlow, полировка, покрытие зубов
                  реминилизирующими препаратами)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Снятие мягких зубных отложений щеткой + пастой, полировка (1
                  зуб)
                </span>
              ...
              <section className="tab-three">
                <span className="text">
                  Снятие зубных отложений пастой, полировка, покрытие "Fluocal
                  gel" (2 челюсти) 1й сеанс
                </span>
                <span className="price">2500₽</span>
              </section>
              <section className="tab-three">
          ...
          <div className="services-content">
            ...
            <div className="services-information" id="information">
              ...
              <div className="information-two">
                <h3 className="heading-info two">Индикация зубного налета</h3>
                <p className="p-info two">
                  Первым этапом процедуры гигиены полости рта является индикация
                  зубного налета. Специальный индикатор окрашивает зубы,
                  позволяя пациенту увидеть наличие зубного налета и определить
                  места, которые требуют более тщательной чистки. Это помогает
                  пациентам сосредоточиться на проблемных областях и улучшить
                  свою домашнюю гигиену.
                </p>
              </div>
              <div className="information-two">
                ...
                <p className="p-info two">
                  ...
                  использованием ультразвука. Ультразвуковая насадка скейлера
                  генерирует миллионы микродвижений в минуту, которые разрушают
                  твердый зубной камень. Эта процедура безболезненная и
                  эффективно удаляет зубные отложения, которые невозможно
                  удалить обычной чисткой зубов.
                </p>
              </div>
              <div className="information-two">
                ...
                <p className="p-info two">
                  После удаления зубных отложений производится полировка
                  поверхностей зубов. Специальные чашечки и головки используются
                  для полировки зубов, придавая им гладкость и блеск. Кроме
                  того, на поверхности зубов наносится фторсодержащий препарат,
                  который помогает укрепить эмаль и предотвратить развитие
                  кариеса.
                </p>
              </div>
              <div className="divider"></div>
              <div className="information-two">
                ...
                <p className="p-info two">
                  ...
                  ваших зубов и десен. Индикация зубного налета, удаление зубных
                  отложений ультразвуком и полировка поверхностей зубов - это
                  эффективные методы, которые помогут вам достичь оптимальной
                  гигиены полости рта. Регулярное проведение профессиональной
                  гигиены полости рта поможет предотвратить развитие заболеваний
                  полости рта и сохранить вашу улыбку здоровой и красивой.
                  Обратившись в нашу клинику, вы получите высококачественное
                  обслуживание от опытных стоматологов, которые помогут вам
                  достичь и поддерживать идеальную гигиену полости рта.
                </p>
              </div>
