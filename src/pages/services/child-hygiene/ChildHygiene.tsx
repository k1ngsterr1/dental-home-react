          ...
          <div className="information-container">
            ...
            <section className="information">
              ...
              <p className="information-paragraph">
                ...
                развитию кариеса, пародонтита и других проблем. Чтобы обеспечить
                детям здоровую улыбку, наша клиника предлагает следующие
                рекомендации по детской гигиене полости рта.
                <br />
                <br />
                ...
                <br />
                <br />
                Сладкие и кислые продукты могут повысить риск развития кариеса.
                Поэтому ограничьте потребление сладостей, газированных напитков
                и кислых фруктов.
                <br />
                <br />
                ...
                профессиональной чистки зубов и осмотра полости рта. Это поможет
                выявить проблемы на ранних стадиях и предотвратить их развитие.
                <br />
                Обеспечение правильной гигиены полости рта у детей является
                важным шагом для поддержания здоровья зубов и десен. Наша
                команда опытных стоматологов готова помочь вам и вашему ребенку
                в обеспечении правильного ухода за зубами и деснами, чтобы
                сохранить здоровую и красивую улыбку на долгие годы.
              </p>
            </section>
          </div>
        </div>
