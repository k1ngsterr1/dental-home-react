        ...
        <div className="text-content">
          ...
          <div className="text-container">
            ...
            <p className="paragraph">
              ...
              ООО "ДЕНТАЛХОУМФЭМИЛИ" (далее — Оператор)
            </p>
            <p className="paragraph">
            ...
            <p className="paragraph">
              <strong>2.1.</strong> Автоматизированная обработка персональных
            ...
            <p className="paragraph">
              ...
              Пользователю веб-сайта https://dental-home.ru.
            </p>
            <p className="paragraph">
            ...
            <p className="paragraph">
              ...
              <br></br>
              <br></br>— получать от субъекта персональных данных достоверные
              информацию и/или документы, содержащие персональные данные;
              <br></br>
              <br></br>— в случае отзыва субъектом персональных данных согласия
              на обработку персональных данных, а также, направления обращения с
            ...
            <p className="paragraph">
              ...
              <br></br>
              <br></br>— организовывать обработку персональных данных в порядке,
              установленном действующим законодательством РФ;
              <br></br>
              <br></br>— отвечать на обращения и запросы субъектов персональных
              ...
              персональных данных;
              <br></br>
              <br></br>— принимать правовые, организационные и технические меры
              ...
              <br></br>
              <br></br>— прекратить передачу (распространение, предоставление,
              ...
              персональных данных;
              <br></br>
              <br></br>— исполнять иные обязанности, предусмотренные Законом о
              персональных данных.
            </p>
            <h4 className="additional-heading two">
            ...
            <p className="paragraph">
              ...
              <br></br>
              <br></br>— на отзыв согласия на обработку персональных данных, а
            ...
            <p className="paragraph">
              ...
              органа или должностного лица, подлежащих исполнению в соответствии
            ...
            <p className="paragraph">
              ...
              либо для достижения общественно значимых целей при условии, что
              при этом не нарушаются права и свободы субъекта персональных
              данных.
            </p>
            <p className="paragraph">
            ...
            <p className="paragraph">
              ...
              электронной почты Оператора info@dental-home.ru с пометкой
          ...
          <div className="information">
            ...
            <div className="text-container" id="two">
              ...
              <p className="paragraph">
                ...
                данных — передача персональных данных на территорию иностранного
                государства органу власти иностранного государства, иностранному
                физическому или иностранному юридическому лицу.
              </p>
              <p className="paragraph">
            ...
            <div className="text-container" id="three">
              ...
              <p className="paragraph">
                ...
                персональных данных и их законных представителей в соответствии
                с требованиями Закона о персональных данных;
                <br></br>
                <br></br>— сообщать в уполномоченный орган по защите прав
                субъектов персональных данных по запросу этого органа
                необходимую информацию в течение 10 дней с даты получения такого
                запроса;
                <br></br>
                <br></br>— публиковать или иным образом обеспечивать
                неограниченный доступ к настоящей Политике в отношении обработки
